<template>
  <div class="flex flex-wrap p-6 mx-auto w-full">
    <div
      id="introduction"
      class="mb-8 xl:w-1/2 xl:px-12 w-full max-w-screen-sm"
    >
      <hgroup class="mb-4">
      ...
      <p class="text-indigo-50 mb-8">
        ...
        downloaded our hearing test app.
      </p>
      <h4 class="text-indigo-50 text-sm uppercase font-bold mb-2">Metric</h4>
      <p class="text-indigo-50 mb-8">
        The main metric for this product was completed tests. They're worth
        measuring because they equate to the core value for the user, but also
        because they generate data to further improve our algorithms.
      </p>
